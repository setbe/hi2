...
- Public headers in `b/` must not include OS headers or expose OS-native types.
...
3. Implement functions declared in `b/detail/port_contract.hpp` for enabled capabilities.
